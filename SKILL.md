...
- **racecar-doc-coherence** → [`doc-coherence/README.md`](doc-coherence/README.md). Doc update protocol + review lens + mechanical pre-pass (link / anchor / section-number drift). Owns [`doc-coherence/scripts/check_docs.py`](doc-coherence/scripts/check_docs.py).
